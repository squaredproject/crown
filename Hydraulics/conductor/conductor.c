...
// PORTB: 	(digital 10-13, 50-53)	PB0-PB3 = mode switch, PB7 = LED on digital 13
// PORTC: 	(digital 30-37)			not used
// PORTD:	(digital 18-21, 38)		PD2 = RXD1, PD3 = TXD1
// PORTE: 	(digital 1,2, 3, 5) 	PE0 = TXD0, PE1 = RXD0, PE4 = RS485 TX enable
// PORTF: 	(adc0-adc7)  			not used
// PORTG:  	(digital 4)				not used
// PORTH:  	(digital 9)				PH0 = RXD2, PH1 = TXD2
// (no PORTI)						does not exist!
// PORTJ:	(digital 14,15)			future implementation of UART3: PJ0 = RXD3, PJ1 = TXD3
